...
import { Column, Direction, SortColumn } from "./types";
import textEditor, { textEditorClassname } from "./editors/textEditor";
import { SelectCellFormatter } from "./cellRenderers/SelectCellFormatter";
...
function getColumns(direction: Direction): readonly Column<Row, SummaryRow>[] {
  return [
    SelectColumn,
    {
      key: "id",
